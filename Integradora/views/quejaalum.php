...
<nav class="navbar navbar-dark bg-dark">
    ...
    <div class="container mt-3">
        <form action="../controllers/enviarqueja.php" method="post" style="margin-top: 130px;">
            <input type="hidden" name="nocontrol"  value="<?php echo $NoControl;?>">
            <input type="hidden" name="nombre"  value="<?php echo $Nombre;?>">
            <h2 style="color:black;">Queja</h2>
            <div class="form-floating">
                <textarea class="form-control" name="queja" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
                <label for="floatingTextarea">Quejas</label>
            </div>
            <button type="submit" name="quejaenvio" class="btn btn-outline-success">Enviar</button>
        </form>
